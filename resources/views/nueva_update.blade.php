...
<body>
    ...
    <div class="container" style="">
        ...
        <div id="current_screen_id">
            ...
            <div class="row" id="current_screen_inside_three" style="margin-top:30px;display: none">
                <div class="col-12">
                    <div style="background-color: #c9e9f2;" class="text-center">
                        <h6 style="padding: 10px">Competencia general</h6>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                ...
                <div class="row" style="margin-top:30px">
                    <div class="col-12" style="justify-content: center;display: flex;">
                        ...
                        <table class="table table-bordered" class="text-center" style="max-width:900px">
                            <thead>
                                <tr>
                                    <th scope="col" colspan="4" width="100%" style="text-align:center;background-color: #d3caff;">Instituciones Participantes</th>
                                </tr>
                                <tr>
                    ...
                    <div class="col-12" style="justify-content: center;display: flex;">
                        ...
                        <div style="width: 900px">
                            <table class="table table-bordered" class="text-center">
                                <thead>
                                    <tr>
                                        <th scope="col" colspan="4" width="100%" style="text-align:center;background-color: #d3caff;">Características de los temas</th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th id="eight_subject_nombre_id" scope="col" width="" style="text-align:center;background-color: #e7e7e7;">Nombre del tema</th>
            ...
            <div class="row" id="current_screen_inside_eleven" style="margin-top:30px;display: none">
                <div class="col-12">
                    <div style="background-color: #c9e9f2;" class="text-center">
                        <h6 style="padding: 10px">Evaluación por competencias (específicas y genericas de la asignatura)</h6>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
            ...
            <div class="col-12">
                <div style="display: flex; justify-content:space-between;background-color: #e8e8e8;">
                    ...
                    <div style="display:flex">
                        <h6 class="import_already_saved" style="margin-right:10px;padding:10px;padding-bottom: 5px;font-size:25px; cursor: pointer;"><i class="hover_effect fa-solid fa-file-import"></i></h6>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" min="0" class="form-control" id="new_institucion_nombre_id" aria-describedby="emailHelp" placeholder="Introduzca el nombre">
                </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">CERRAR</button>
    ...
    <script>
        ...
        //Estamos implementando en nuestro programa frontend con Javascript y Jquery para
        //poder interactuar con nuestro controlador y modelos
        //Podriamos utilizar solo html pero sería demasiado difícil manejar completamente el sitio de esa manera
        //Normalmente nosotros enviamos peticiones una y otra vez para poder hacerle
        //Fetch y enviar los datos al controlador y modelos, sin embargo en esta ocasión
        //Con Js Y Jquery enviamos y recibimos data con Fetch requests o requests de Ajax
        //Lo mejor de estas peticipnes es que NO necesitamos actualizar la pag.
        
        //Aquí abajo tenemos todo el código relacionado al front
        //Donde pasamos la data a cada uno de los componentes y los organizamos en variables
        //para manterlas organizadas en arrays

        $(document).ready(function(){

            //Debajo se encuentra la petición necesaria de ajax para que no nos salte error relacionado al token csrf necesario para laravel
            $.ajaxSetup({
                headers: {
            ...
            //Este es el id de edición que utilizamos, de igual manera editando_datos es la variable que utilizamos para
            //guardar la data a la que le hemos hecho fetch del sistema en un request del get
            var global_edit_id = 0;
            var editando_datos = "";
            
            //Debajo se encuentran las variables de esta parte
            ...
            //Esta función de aquí abajo se utiliza para abrir cada detalle del tema, osease sus 4 propiedades de cada uno
            ...
            function cambiar_pantalla_principal(current_screen_inside)
            {
                ...
                if(current_screen_inside == 7){
                    ...
                    //En esta pantalla necesitamos inializar los detalles de los temas así que lo hacemos llamando a la sig función
            ...
            //Esta función se utiliza para cambiar las pantallas entre las propiedades de cada tema seleccionado
            ...
            //Esta función se usa para actualizar los temas y su respectiva data cuando
            //llamamos a esta funcion entonces toda la data relaciona a los temas de la materia se actualizan
            ...
            //Esta es la función principal en la que le enviamos nuestros datos al controlador mediante peticiones de ajax y jquery
            $(".save-btn").on("click",function(){
                ...
                //Este es el método de Jquery ajax post request (tuve que leer la documentación para maso entender qué hace)
                $.ajax({
                    type: 'POST',
                    url: "http://127.0.0.1:8000/nueva/update",
                    data: formData,
            ...
            //Abajo se encuentra la función utilizada para mostrar los 2 primeros detalles (propiedades) que están guardadas en la pag de añadir o remover temas
            $(document).on('click',".show_subject_detail",function(){

                console.log($(this).attr('check_index'));
            ...
            //Función usada para cambiar pantallas entre las ya mencionadas propiedades
            ...
            //Esta es la función en la que se guarda el valor de la primera propiedad del objeto
            ...
            //Esta es la función en la que se guarda el valor de la segunda propiedad del objeto
            ...
            //Función on click usada para cambiar el sort del array cuando una pantalla en especifico sea abierta, entonces el sort cambia a orden ascendente
            ...
            //Función on click usada para cambiar el sort del array cuando una pantalla en especifico sea abierta, entonces el sort cambia a orden descendente
            ...
            $(document).on('click',".remove_thing_handler",function(){
                if(pantalla_actual == 3){
                    console.log(indice_de_eliminacion_institucion_new);
                    ...
                    console.log(indice_de_eliminacion_evento_new);
                    ...
                    console.log(indice_de_eliminacion_subject_new);
            ...
            //Los metodos de aquí debajo los usamos para obtener los datos ya guardados de nuestra BDD, obtenemos el index de la ruta y entonces
            //con la ayuda de el index asignatura obtenemos los datos relacionados a la materia y lo guardamos en la variable
            ...
            global_edit_id = edit_id;

            $.ajax({
                type:"GET",
                url:`http://127.0.0.1:8000/open_one_course/${edit_id}`,
            }).done(function(data){
                console.log(data);
                editando_datos = data.data;
                if(data.status == true)
                {
                    document.getElementById('main_one_id').value = data.data.clave;
                    document.getElementById('main_two_id').value = data.data.nombre;
                    document.getElementById('main_four_id').value = data.data.teoricas;
                    document.getElementById('main_five_id').value = data.data.practicas;
                    document.getElementById('main_fourteen_id').value = data.data.programa_date;
                }
            });

            //Esta es la función que nos permite importar la información con el botón, primero detecta en que pantalla está y luego la trae de la BDD.

            $(".import_already_saved").on("click",function(){
                console.log(pantalla_actual);
                console.log(editando_datos);

                if(pantalla_actual == 1){
                    document.getElementById('main_six_id').value = editando_datos.caracterizacion;
                }
                if(pantalla_actual == 2){
                    document.getElementById('main_seven_id').value = editando_datos.didactia;
                }
                if(pantalla_actual == 3){
                    institucion_matriz = editando_datos.whole_object_three;
                    actualizar_productos_instituciones();
                }
                if(pantalla_actual == 4){
                    document.getElementById('main_fifteen_id').value = editando_datos.detalle_evento;
                    evento_matriz = editando_datos.whole_object_two;
                    refresco_productos_eventos();
                }
                if(pantalla_actual == 5){
                    document.getElementById('main_eight_id').value = editando_datos.general;
                    document.getElementById('main_nine_id').value = editando_datos.previas;
                }
                if(pantalla_actual == 6 || pantalla_actual == 7){
                    sujetos_matriz = editando_datos.whole_object;
                    actualizar_productos();
                    octavo_cambio_de_sujeto(0);
                }
                if(pantalla_actual == 8){
                    document.getElementById('main_ten_id').value = editando_datos.laboratorio;
                }
                if(pantalla_actual == 9){
                    document.getElementById('main_eleven_id').value = editando_datos.proyecto;
                }
                if(pantalla_actual == 10){
                    document.getElementById('main_twelve_id').value = editando_datos.evaluacion_competencias;
                }
                if(pantalla_actual == 11){
                    document.getElementById('main_thirteen_id').value = editando_datos.fuentes;
                }
            });

            //Esta función llama a la primera pantalla para hacerle display hasta el frente.
